  ...
  Widget build(BuildContext context) {
    final modules = [
      ...
      _ModuleItem(
        ...
        '${UiText.digits(context, '50')} ${UiText.t(context, 'Practical Tools')}',
      ...
      _ModuleItem(
        ...
        '${UiText.digits(context, '20')} ${UiText.t(context, 'SVG Diagrams')}',
      ...
      _ModuleItem(
        ...
        '${UiText.digits(context, '200')} ${UiText.t(context, 'Questions')}',
        Icons.quiz_rounded,
      ...
      _ModuleItem(
        UiText.t(context, 'Manual Resistor Band Reader'),
