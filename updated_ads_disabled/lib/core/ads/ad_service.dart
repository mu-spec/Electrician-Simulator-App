...
class AdService with WidgetsBindingObserver {
  ...
  static const Duration coldStartMaxWait = Duration(seconds: 6);

  /// Show resume app-open if user was away at least this long.
  static const Duration minBackgroundForResumeAd = Duration(seconds: 30);
  ...
  final ValueNotifier<bool> adsFreeNotifier = ValueNotifier<bool>(true); // ADS DISABLED GLOBALLY

  bool get isInitialized => _initialized;
  bool get isAdsFree => true; // ADS DISABLED GLOBALLY
